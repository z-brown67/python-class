...
# Main.playGame()
board=Grid()
board.change(Location(5, 5), WHITE)
board.change(Location(4, 5), BLACK)
board.change(Location(6, 5), BLACK)
board.change(Location(5, 4), BLACK)
board.change(Location(5, 6), BLACK)
print(board)
board.updateBoard(Location(5, 6), BLACK)
print(board)